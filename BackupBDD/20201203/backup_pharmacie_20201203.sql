...
INSERT INTO `categories` VALUES (1,'Non renseigné','Non renseigné'),(4,'Antiviraux','Non'),(5,'Cardiologie','Oui');
...
INSERT INTO `commandes` VALUES (1,'2020-12-01','2020-12-08',1,5),(2,'2020-11-10','2020-11-20',2,1),(3,'2020-10-20','2020-11-10',3,5);
...
INSERT INTO `produits` VALUES (1,'Doliprane','Doliprane','aucune','2020-12-30',6,2500,4,8),(2,'Gaviscon','desc','pas avant de dormir','2022-02-02',12,633,1,10),(3,'Drill','medicament pour la gorge','pas pour les bébé','2021-12-06',3.8,200,1,2),(4,'Spifen400','Spifen','Interdit aux femmes enceintes et enfant de moins de 10 ans','2021-11-07',12.77,300,1,9),(5,'paracetamol','paracetamol','aucune','2021-02-11',20,60,1,1),(6,'smecta','smecta','Interdit au plus de 68 ans','2023-12-12',13,652,5,13),(7,'spashon','spashon','que pour les filles','2022-06-08',6.8,182,1,14);
...
INSERT INTO `roles` VALUES (1,'Inconnu'),(2,'Admin'),(3,'Users');
...
INSERT INTO `users` VALUES (1,'Rodriguez','Alberto',35,2),(2,'Dupont','Toto',25,1),(3,'Dupont','Titi',25,1),(4,'Dupont','Tata',25,1),(5,'Rodriguez','Albertine',35,2);
...
-- Dump completed on 2020-12-03 17:00:02
