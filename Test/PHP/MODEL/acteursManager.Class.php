...
class ActeursManager 
{
	...
	{
 		$db=DbConnect::getDb();
		$q=$db->prepare("UPDATE Acteurs SET idActeur=:idActeur,nomActeur=:nomActeur,prenomActeur=:prenomActeur,origineActeur=:origineActeur,dateDeNaissanceActeur=:dateDeNaissanceActeur WHERE idActeur=:idActeur");
