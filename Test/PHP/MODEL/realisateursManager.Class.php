...
class RealisateursManager 
{
	...
	{
 		$db=DbConnect::getDb();
		$q=$db->prepare("UPDATE Realisateurs SET idRealisateur=:idRealisateur,nomRealisateur=:nomRealisateur,prenomRealisateur=:prenomRealisateur,dateDeNaissanceRealisateur=:dateDeNaissanceRealisateur,paysOrigineRealisateur=:paysOrigineRealisateur WHERE idRealisateur=:idRealisateur");
