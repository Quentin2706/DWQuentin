<?php
 ...
 Class MonstreDifficile extends MonstreFacile {
	...
	public function sortMagique($resultmonstre,$monstre, $joueur) {
		if ($resultmonstre != 6)            // Si le monstre a fait un chiffre différent de 6 alors il enclenche son sort magique
            {
                $resultmonstre=$resultmonstre*5;
                return $monstre->attaque($joueur,$resultmonstre);
            }
	}
	/**
	...
	*/
	public function toString(){
		return " Etat du monstre : ".$this->getEtatMonstre();
	}
