...
// $newp = new Produits(["libelleProduit" => "cahier", "prix" => 5, "dateDePeremption" => '2020-12-31']);
// Produitsmanager::add($newp);

// on affiche la liste de produits
...
// $pSuppr = ProduitsManager::findById(2);
