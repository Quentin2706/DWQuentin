...
<div class="block vwmain margeV">
    ...
    <div class="centrer margeV">
        <img src="./IMG/soleil.jpg" class="image">
    </div>
    <div class="galaxie block">
        <div>
            <div class="espace"></div>
            <div class="texte helvetica">
                L’histoire commence il y a 15 milliards d’années lors du Big-Bang. Cet instant 0 donne naissance
                à l’Univers tel que nous le connaissons aujourd’hui avec son cortège de galaxies, pulsars,
                quasars et autres. Ce qui nous intéresse est une galaxie de 100 000 années-lumière de diamètre
                que l’on appelle « Voie Lactée ». A quelques 28 000 années-lumière du centre galactique gravite
                une étoile de type naine jaune, baptisée « Soleil ». Elle est entourée de 8 planètes et leur
                cortège de lunes, d’innombrables astéroïdes et autres comètes. C’est notre système solaire.
            </div>
            <div> </div>
            <div> </div>
            <div> </div>
        ...
        <div>
            ...
            <div> </div>
            <div class="texte helvetica">
                Tournoyant dans le disque protoplanétaire, la matière se concentre par endroits en raison de
                turbulence dans le disque. Cette accumulation aboutit à la formation d’objets de quelques
                kilomètres de long que l’on appelle les planétésimaux. Par un phénomène d’accrétion, ils vont
                s’assembler pour constituer les planètes.
            </div>
            <div class="espace"></div>
        </div>
        <div>
            <div class="espace"></div>
            <div class="texte helvetica">
                La répartition de la matière dans le disque protoplanétaire est l’élément clé dans la nature des
                planètes. A moins de quatre Unités Astronomiques, on retrouve les éléments lourds qui serviront
                à former les planètes telluriques et les corps solides de la Ceinture d’astéroïdes. Au-delà, le
                disque est essentiellement constitué d’éléments volatils. Présents en beaucoup plus grande
                quantité, ils seront les constituants des planètes géantes gazeuses et des comètes. On estime
                qu’il aura fallu entre 50 à 100 millions d’années pour former les planètes telluriques contre 10
