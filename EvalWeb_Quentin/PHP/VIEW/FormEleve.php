...
case "ajout" :
    {
        ...
        echo '<form action="index.php?page=ActionsEleve&mode=ajout" method="POST">';
        break;
    }
case "modif" :
    {
        echo '<form action="index.php?page=ActionsEleve&mode=modif" method="POST">';
    break;
    }
case "suppr" :
    {
        echo '<form action="index.php?page=ActionsEleve&mode=suppr" method="POST">';
    break;
    }
...
?>
    ...
    <div class="colonne">
        ...
        <div></div>
            ...
            <input name="prenomEleve" class="centrer listelib" <?php if($mode != "ajout") echo 'value= "'.$choix->getPrenomEleve().'"';if($mode=="suppr") echo '" disabled'; ?>/>
            <div></div>
        </div>
        <div class="margeV">
        <div></div>
            <div class="centrer listelib">Classe : </div>
            <input name="classe" class="centrer listelib" <?php if($mode != "ajout") echo 'value= "'.$choix->getClasse().'"';if($mode=="suppr") echo '" disabled'; ?>/>
            <div></div>
        </div>
    </div>
    <div>
