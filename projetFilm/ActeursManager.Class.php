...
class ActeursManager
{
    ...
    // {
    //     $db = DbConnect::getDb();
    //     $q = $db->prepare("UPDATE Acteurs SET nomActeur=:nomActeur, dateActeur=:dateActeur, coutActeur=:coutActeur, dureeActeur=:dureeActeur, synopActeur=:synopActeur, idStudio=:idStudio, idGenre=:idGenre WHERE idActeur=:idActeur");
    //     $q->bindValue(":idActeur", $obj->getIdActeur());
    //     $q->bindValue(":nomActeur", $obj->getNomActeur());
    //     $q->bindValue(":dateActeur", $obj->getDateActeur());
    //     $q->bindValue(":coutActeur", $obj->getCoutActeur());
    //     $q->bindValue(":dureeActeur", $obj->getDureeActeur());
    //     $q->bindValue(":synopActeur", $obj->getSynopActeur());
